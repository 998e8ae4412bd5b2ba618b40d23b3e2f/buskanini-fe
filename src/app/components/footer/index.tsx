            ...
            <div className={styles.footerContainer}>
                <div className={styles.footerInfoNav}>
                    <div className={styles.footerInfo}>
                        ...
                        <p>Ми створюємо унікальні рішення та пропонуємо широкий асортимент меблів і освітлення, щоб
                            перетворити кожен простір на джерело натхнення і затишку.</p>
                    </div>
                    ...
                    <div className={styles.footerNav}>
                        ...
                        <nav className={styles.footerNavList}>
                            ...
                            <ul className={styles.vertical}>
                                ...
                                <li><Link href='/'>Портфоліо</Link></li>
