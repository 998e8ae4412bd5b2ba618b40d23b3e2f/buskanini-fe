        ...
        <div className={styles.content}>
          <div className={styles.aboutMeTexts}>
            ...
            <p>
              ...
              любов до дизайну з моїм досвідом у 3D-моделюванні. <br/> Мені подобається
              створювати мінімалістичні та ергономічні меблі, які розповідають
              історію та покращують будь-який простір.<br/> Кожна модель, яку я
          ...
          <div className={styles.aboutMeInfo}>
            <div className={styles.aboutMeInfoImage}
                 style={{backgroundImage: `url(/images/about/MykolaBuskaniuk.webp)`}}
            />
